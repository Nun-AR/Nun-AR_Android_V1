...
class RecentPostAdapter :
    ListAdapter<PostResponse, RecentPostAdapter.RecentPostViewHolder>(RecentPostDiffUtilCallback) {
    ...
    object RecentPostDiffUtilCallback : DiffUtil.ItemCallback<PostResponse>() {
